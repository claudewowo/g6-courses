      ...
      treeGraph = new TreeGraph({
        ...
        layout: {
          ...
          getWidth (d) {
            ...
            const width = labelWidth + baseConfig.nodePaddingLeft + baseConfig.nodePaddingRight + 20;
    ...
    registerNode () {
      registerNode('tree-node', {
        draw (cfg, group) {
          ...
          const nodeWidth = baseConfig.nodePaddingLeft + textWidth + baseConfig.nodePaddingRight + (children && children.length ? countWidth : 0) + 10;
